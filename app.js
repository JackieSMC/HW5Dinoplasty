class App {
    constructor(selectors) {
        ...
        document.querySelector('.menu-text').addEventListener('click', this.addAllList.bind(this))

        document.querySelector('.carnivore-menu').addEventListener('click', this.addCarnivoreList.bind(this))

        document.querySelector('.herbivore-menu').addEventListener('click', this.addHerbivoreList.bind(this))

        document.querySelector('.omnivore-menu').addEventListener('click', this.addOmnivoreList.bind(this))

        document.querySelector('.searchBar').addEventListener('keyup', this.search.bind(this))
        
        this.carnivoreList = document.querySelector(selectors.carnivoreSelector)
        
        this.herbivoreList = document.querySelector(selectors.herbivoreSelector)
        
        this.omnivoreList = document.querySelector(selectors.omnivoreSelector)
